from .base_options import BaseOptions  # Import BaseOptions as the base class for handling options

# Define the TrainOptions class, inheriting from BaseOptions
class TrainOptions(BaseOptions):
    def initialize(self):
        BaseOptions.initialize(self)  # Call the parent class initialize method

        # Options for displaying results during training
        ...
        # Options related to the discriminator(s)
        ...
        self.isTrain = True  # Set the isTrain attribute to True, indicating this class is used for training
